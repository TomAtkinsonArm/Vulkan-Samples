...
namespace vkb
{
AndroidWindow::AndroidWindow(AndroidPlatform *platform, ANativeWindow*& window, const WindowProperties &properties) :
    Window(properties),
    handle{window}
{
	headless = properties.mode.value_or(WindowMode::Default) == WindowMode::Headless;
}
