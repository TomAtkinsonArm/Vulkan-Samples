...
class Parser
{
  public:
	...
	/**
	 * @brief Get the float object of a given flag
	 * 
	 * @param flag Flag used to retrieve float value
	 * @return A float value stored by the flag
	 */
	const float get_float(const Flag &flag) const;
