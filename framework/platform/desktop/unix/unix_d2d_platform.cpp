...
void UnixD2DPlatform::create_window(WindowProperties properties)
{
	DesktopPlatform::revise_window_properties(&properties);

	auto mode = properties.mode.value_or(WindowMode::Default);
	if (mode == vkb::Window::WindowMode::Headless)
	{
